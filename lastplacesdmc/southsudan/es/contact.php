...
<title>Contact - South Sudan</title>
...
<body>
					...
					<div class="row">
						...
						<div class="col-md-1">
							<select class="selectpicker" data-width="fit" onchange="location = this.value;">
								<option value="/lastplacesdmc/southsudan/" data-content='<span class="flag-icon flag-icon-us"></span> English'>English</option>
								<option value="/lastplacesdmc/southsudan/es/"  data-content='<span class="flag-icon flag-icon-mx"></span> Espanol' selected>Espanol</option>
							</select>	  
						</div>
					</div>
					  ...
					  <div class="container">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
						  <ul class="navbar-nav ml-center">
							<li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/southsudan/es/index.php">South Sudan</a>
							</li>

							<li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/southsudan/es/gallery-tribes.php">Tribus</a>
							</li>

							<li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/southsudan/es/gallery-nature.php">Naturaleza</a>
							</li>

						   <li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/southsudan/es/contact.php">Contacto</a>
							</li>
						 </ul>
						</div>
					  </div>
	...
	<section id="sites">
		<div class="container">
			<div class="row text-center">
				<div class="col-sm-12">
					<h1>Enviar un mensaje rapido</h1>
				</div>
			</div>
		</div>
	</section>
				    ...
				    <div class="form-row">
                       ...
                       <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-12">
                            <textarea name="comments" placeholder="Escriba su mensaje aqui..."></textarea>
                        </div>
                        <div class="form-group col-md-12">
	...
	<footer>
		<div class="widget-area text-center">
			<h3>Tenemos una manera unica de satisfacer tus expectativas aventureras.</h3>
