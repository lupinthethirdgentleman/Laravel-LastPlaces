...
<title>Gallery Tribes - West Africa DMC</title>
					...
					<div class="row">
						...
						<div class="col-md-1">
							<select class="selectpicker" data-width="fit" onchange="location = this.value;">
								<option value="/lastplacesdmc/westafrica/" data-content='<span class="flag-icon flag-icon-us"></span> English' selected>English</option>
								<option value="/lastplacesdmc/westafrica/es/"  data-content='<span class="flag-icon flag-icon-mx"></span> Español'>Español</option>
							</select>	  
						</div>
					</div>
					  ...
					  <div class="container">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
						  <ul class="navbar-nav ml-center">
							<li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/westafrica/index.php">West Africa</a>
							</li>

							<li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/westafrica/gallery-tribes.php">Tribes</a>
							</li>

							<li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/westafrica/gallery-nature.php">Nature</a>
							</li>

						   <li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/westafrica/contact.php">Contact</a>
							</li>
						  </ul>
						</div>
					  </div>
