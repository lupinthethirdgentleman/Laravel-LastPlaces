...
<head>
<meta charset="utf-8">
<title>Galería de la naturaleza - Angola DMC</title>
 <meta charset="utf-8">
...
<body>
					...
					<div class="row">
						...
						<div class="col-md-1">
							<select class="selectpicker" data-width="fit" onchange="location = this.value;">
								<option value="/lastplacesdmc/angola/" data-content='<span class="flag-icon flag-icon-us"></span> English'>English</option>
								<option value="/lastplacesdmc/angola/es/"  data-content='<span class="flag-icon flag-icon-mx"></span> Español' selected>Español</option>
							</select>	  
						</div>
					</div>
					  ...
					  <div class="container">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
						  <ul class="navbar-nav ml-center">
							<li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/angola/es/index.php">Angola</a>
							</li>

							<li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/angola/es/gallery-tribes.php">Tribus</a>
							</li>

							<li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/angola/es/gallery-nature.php">Naturaleza</a>
							</li>

						   <li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/angola/es/contact.php">Contacto</a>
							</li>
						 </ul>
						</div>
					  </div>
	...
	<section id="sites" style="background:#e7e7e7;">
		<div class="container">
			<div class="row text-center">
				<div class="col-sm-12">
					<h1>Galería de la naturaleza</h1>
				</div>
			</div>
		<!----Images gallery--->
			<?php
			$table='photos_country_nature';
			$result = $mysqli->query("SELECT * FROM $table WHERE country_id=9") or die($mysqli->error);
	...
	<footer>
		<div class="widget-area text-center">
			...
			<!--Social Icons Disable Comment start
			...
			Social Icons Disable Comment end-->
