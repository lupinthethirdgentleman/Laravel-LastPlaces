...
<head>
<meta charset="utf-8">
<title>Gallery Tribes - Angola DMC</title>
 <meta charset="utf-8">
...
<meta name="author" content="Manish Bajpai - Codexious Digital Agency" />
	<link rel='icon' href='img/Lastplaces6.jpg' type='image/x-icon'/ >
<!----Stylesheets start---->	
					...
					<div class="row">
						...
						<div class="col-md-1">
							<select class="selectpicker" data-width="fit" onchange="location = this.value;">
								<option value="/lastplacesdmc/angola/" data-content='<span class="flag-icon flag-icon-us"></span> English' selected>English</option>
								<option value="/lastplacesdmc/angola/es/"  data-content='<span class="flag-icon flag-icon-mx"></span> Español'>Español</option>
							</select>	  
						</div>
					</div>
					  ...
					  <div class="container">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
						  <ul class="navbar-nav ml-center">
							<li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/angola/index.php">Angola</a>
							</li>

							<li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/angola/gallery-tribes.php">Tribes</a>
							</li>

							<li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/angola/gallery-nature.php">Nature</a>
							</li>

						   <li class="nav-item">
							  <a class="nav-link" href="/lastplacesdmc/angola/contact.php">Contact</a>
							</li>
						  </ul>
						</div>
					  </div>
