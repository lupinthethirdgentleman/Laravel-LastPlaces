...
<head>
<meta charset="utf-8">
<title>Galeria de la naturaleza - East Africa DMC</title>
 <meta charset="utf-8">
...
<body>
					...
					<div class="row">
						...
						<div class="col-md-1">
							<select class="selectpicker" data-width="fit" onchange="location = this.value;">
								<option value="/lastplacesdmc/eastafrica/" data-content='<span class="flag-icon flag-icon-us"></span> English' >English</option>
								<option value="/lastplacesdmc/eastafrica/es/"  data-content='<span class="flag-icon flag-icon-mx"></span> Español' selected>Español</option>
							</select>	  
						</div>
					</div>
	...
	<section id="sites" style="background:#e7e7e7;">
		...
		<!----Images gallery--->
			...
			$result = $mysqli->query("SELECT * FROM $table WHERE country_id=8") or die($mysqli->error);
