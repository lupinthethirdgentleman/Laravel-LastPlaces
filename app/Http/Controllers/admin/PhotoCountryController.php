...
class PhotoCountryController extends BaseController
{
    ...
    public function index()
    {
        ...
        Breadcrumb::addBreadcrumb(trans("Photo Country Tribes Gallery"),route($this->model.'.index'));
        $breadcrumbs    =   Breadcrumb::generate();
        ### breadcrumbs End ###

        $DB             =   PhotoCountry::query();
    ...
    public function create()
    {
        ...
        Breadcrumb::addBreadcrumb(trans("messages.global.breadcrumbs_dashboard"),route('admin_dashboard'));
        Breadcrumb::addBreadcrumb(trans("Country Photo Tribes Gallery"),route($this->model.'.index'));
    ...
    public function store(Request $request)
    {
        ...
        {   return Redirect::back()
           ...
           //  print_r(Input::file('image')[$i]); 
            ...
            PhotoCountry::insert($insert_batch_array);
    ...
    public function edit($id)
    {
        //
      //  echo $id;
        $photos		=	PhotoCountry::where('country_id','=',$id)->get();
...
$model   =   Region:: findorFail($id);
    ...
    {
        $photo = PhotoCountry::findorFail($id);
    ...
    public function savetitle()
    {
        ...
        if($image_title!='')
        {
            $PhotoCountry=PhotoCountry::where('id','=',$image_id)->update(array('title'=>$image_title));
