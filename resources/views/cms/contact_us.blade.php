        ...
        <div class="row">
            <!-- <div class="col-sm-4">
                <div class="page_title">
                    ...
                    {{ Config::get('Site.address')}}
                    <strong>Call:</strong>{{ Config::get('Site.phone')}}<br>
                    <strong>Fax:</strong> {{ Config::get('Site.fax')}}<br><br>
                    <strong>Email:</strong> {{ Config::get('Site.contact_email')}}</p>
                </div>
            </div> -->
            ...
            <div class="col-sm-8" id="scroll_error_signup">
                <div class="login_form">
                    <h2>{{trans('messages.filltheformbelow')}}<br> <small>{{trans('messages.wewillgetback')}}</small></h2>
                    <div id="error_div_signup" style="display:none"></div>
                    {{ Form::open(['role' => 'form','url' => 'contact-us','id'=>'contactus_form', 'name'=>'contactus_form','method'=>'post','class'=>'form']) }}
