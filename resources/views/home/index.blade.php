                        ...
                        @foreach($blocksBlogForHighlight as $highblogs)
                            ...
                            @if($highblogs->is_highlight == 1)
                                ...
                                <div class="bigpost_content">
                                    ...
                                    <div class="bigpost_description"><a href="{{ URL::to('blogs/'.$highblogs->slug) }}">
                                        {{str_limit($highblogs->description, 100);}}</a></div>
                                </div>
                            @endif
                    ...
                    @else
                        ...
                        @foreach($blocksBlog as $highblogs)
                            ...
                            <div class="bigpost_content">
                                ...
                                <div class="bigpost_description">{{ strip_tags(Str::limit($highblogs->description, 100)) }}
                                    <!-- {{str_limit($highblogs->description, 100);}} --></div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="bigpost_description">
                                        {{ strip_tags(Str::limit($blogs->blogDescription->description, 150)) }}
