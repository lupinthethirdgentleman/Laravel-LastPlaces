        ...
        <div class="row">
        	<div class="col-sm-6 col-lg-4"  id="scroll_error_login">
            	<div class="login_form gray_box">
                    ...
                    {{ Form::open(['role' => 'form','class'=>'form','snovalidate'=>'novalidate','id'=>'login_form','route' =>'login']) }}
                      ...
                      {{
                        ...
                        <a href="{{ route('front-forgot-password') }}" class="fget_pass">Forget Password</a>    
                    </form>
                    <!-- <div class="border_middle text-center">
                    	<span>OR</span>
                    </div>
                    <div class="facebook_login"><a href="#"><img class="img-responsive" src="{{ WEBSITE_IMG_URL }}/fb_login.png" alt=""/></a></div>
                    <div class="twitter_login"><a href="#"><img class="img-responsive" src="{{ WEBSITE_IMG_URL }}/twitter_btn.png" alt=""/></a></div> -->
            	</div>
            </div>
