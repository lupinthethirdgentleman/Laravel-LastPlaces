...
<div class="mws-panel grid_8">
	...
	{{ Form::open(['role' => 'form','url' => 'admin/meta-manager/edit-meta/'.$meta->id,'class' => 'mws-form']) }}
	...
	<div class="mws-panel-body no-padding tab-content">
			...
			<div id="{{ $i }}div" class="tab-pane {{ ($i ==  $language_code )?'active':'' }} ">
				<div class="mws-form-inline">
					<div class="mws-form-row ">
						...
						<div class="mws-form-item">
							{{ Form::text("data[$i][meta_keyword]",isset($multiLanguage[$i]['meta_keyword'])?$multiLanguage[$i]['meta_keyword']:'', ['class' => 'small']) }}
							<div class="error-message help-inline">
					...
					<div class="mws-form-row ">
						...
						<div class="mws-form-item">
							{{ Form::text("data[$i][meta_title]",isset($multiLanguage[$i]['meta_title'])?$multiLanguage[$i]['meta_title']:'', ['class' => 'small']) }}
							<div class="error-message help-inline">
		...
		<div class="mws-button-row">
			<div class="input" >
				...
				<a href="{{URL::to('admin/meta-manager/edit-meta/'.$meta->id)}}" class="btn primary"><i class=\"icon-refresh\"></i> {{ trans('messages.system_management.reset') }}</a>
			</div>
		</div>
	</div>
	{{ Form::close() }} 
