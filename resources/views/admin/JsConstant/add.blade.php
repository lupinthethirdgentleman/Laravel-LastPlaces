...
<div class="mws-panel grid_8">
	<div class="mws-panel-header"  style="height: 46px;">
		<span> {{ trans("messages.settings.table_heading_JsConstant_module_add") }}</span>
	...
	@endif
	{{ Form::open(['role' => 'form','url' =>'admin/jsconstant-setting/save-new-text/'.$type,'class' => 'mws-form']) }}
	...
	<div class="mws-button-row">
		<div class="input" >
			...
			<a href="{{URL::to('admin/jsconstant-setting/add-new-text/'.$type)}}" class="btn primary"><i class=\"icon-refresh\"></i> {{ trans("messages.global.reset") }}</a>
		</div>
	</div>
