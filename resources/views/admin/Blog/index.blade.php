						...
						foreach($model as $result){ ?>
							<tr class="items-inner">
								...
								<td  data-th='{{ trans("messages.$modelName.image") }}'>
									@if($result->image!='' && File::exists(BLOG_IMAGE_ROOT_PATH.$result->image))
									<a class="items-image" data-lightbox="roadtrip<?php echo $result->image; ?>" href="<?php echo BLOG_IMAGE_URL.$result->image; ?>">
									
									{{ HTML::image( BLOG_IMAGE_URL.$result->image, $result->image , array( 'width' => 70, 'height' => 70 )) }}
