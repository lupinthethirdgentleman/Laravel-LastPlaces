		...
		<div class="mws-panel-body no-padding">
			...
			<div class="mws-form-inline">
				<div class="mws-form-row">
					{{  HTML::decode(Form::label('image', trans("messages.$modelName.image"), ['class' => 'mws-form-label'])) }}
					<div class="mws-form-item">
						{{ Form::file('image') }}
						@if(File::exists(NEWS_IMAGE_ROOT_PATH.$model->image))
						{{ HTML::image( NEWS_IMAGE_URL.$model->image, $model->image , array( 'width' => 70, 'height' => 70 )) }}
						@endif
