...
<div class="mws-panel grid_8">
	...
	<div class="mws-panel-header" style="height: 46px;">
		...
		{{ Form::open(['role' => 'form','url' =>  route("$modelName.edit","$region->id"),'class' => 'mws-form']) }}
	...
	<div class="mws-panel-body no-padding">
		...
		<div class="mws-panel-body no-padding tab-content"> 
			...
			{{ Form::text("data[$i][".'name'."]",isset($multiLanguage[$i]['name'])?$multiLanguage[$i]['name']:'', ['class' => 'small']) }}									<div class="error-message help-inline">
						...
						<div class="mws-form-item">
							{{ Form::textarea("data[$i][".'introduction'."]",isset($multiLanguage[$i]['introduction'])?$multiLanguage[$i]['introduction']:'', ['class' => 'small','id' => 'body_'.$i]) }}
			...
			<div class="input" >
				...
				<a  href='{{ route("$modelName.edit","$region->id")}}' class="btn primary"><i class=\"icon-refresh\"></i> {{ trans('messages.global.reset') }}</a>
			</div>
		</div>
		</div>
