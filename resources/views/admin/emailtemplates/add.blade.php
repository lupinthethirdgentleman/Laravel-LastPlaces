...
<div class="mws-panel grid_8">
	<div class="mws-panel-header">
		<span> {{ trans("messages.system_management.add_email_template") }} </span>
		...
		{{ Form::open(['role' => 'form','url' => 'admin/email-manager/add-template','class' => 'mws-form']) }}
			...
			<div class="mws-button-row">
				<div class="input" >
					...
					<a href="{{URL::to('admin/email-manager/add-template')}}" class="btn primary"><i class=\"icon-refresh\"></i> {{ trans('messages.system_management.reset')  }}</a>
				</div>
			</div>
		{{ Form::close() }}
	</div>    	
