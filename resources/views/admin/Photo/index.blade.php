...
<div  class="mws-panel grid_8 mws-collapsible">
	<div class="mws-panel-header">
		<span>
			...
			<a href='{{URL::to('admin/photo-manager/add')}}'  class="btn btn-success btn-small align">{{ trans("messages.$modelName.add_new") }} </a>
	</div>
			...
			<tbody>
				...
				<tr>
					...
					<td  data-th='{{ trans("messages.global.status") }}'>
						...
						<a href='{{URL::to('admin/photo-manager/view-photos/'.$result->trip_id)}}' class="btn btn-info btn-small mt5">{{ trans("messages.global.view")}} </a>
