...
<div  class="mws-panel grid_8 mws-collapsible">
	<div class="mws-panel-header">
		<span>
			<i class="icol-status-online"></i> {{ trans("messages.$modelName.view_enquiry") }} 
		</span>
	...
	<div class="mws-panel-body no-padding dataTables_wrapper">
		<table class="mws-table mws-datatable">
			<tbody>
				<tr>
					<th width="30%" class="text-right">{{ trans("messages.$modelName.tripname") }}</th>
					<td data-th='{{ trans("messages.$modelName.name") }}'>{{ $model->trip->tripname }}</td>
				</tr>
				<tr>
...
<div class="mws-panel grid_8" id="reply">
	...
	<div class="mws-panel-body no-padding dataTables_wrapper">
			...
			{{ Form::hidden('trip_name',$model->trip->tripname) }}
