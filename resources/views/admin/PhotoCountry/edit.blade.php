...
<div class="mws-panel grid_8">
	...
	<div class="mws-panel-header" style="height: 46px;">
		<span> {{ trans("View Country Tribes Photos") }} </span>
		...
		<div class="mws-panel-body no-padding tab-content"> 
			...
			<div class="image_display">
				...
				<div style="margin-top:10px;">
					<a href="{{URL::to('/admin/photo-country-manager/delete-photo/'.$photo_display->id)}}" class="btn btn-danger">Delete</a>
...
<script type="text/javascript">
	function updateTitle(imageId){
		...
		var imageTitle = $("#image_id"+imageId).val();
	  	$.ajax({
	        type: "POST",
	        url : "{{url('/admin/photo-country-manager/save-title')}}",
