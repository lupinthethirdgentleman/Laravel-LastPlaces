...
<div  class="mws-panel grid_8 mws-collapsible">
	<div class="mws-panel-header">
		<span>
			<i class="icon-table"></i> {{ trans("Photo Country Tribes Gallery")}}</span>
			<a href='{{URL::to('admin/photo-country-manager/add')}}'  class="btn btn-success btn-small align">{{ trans("Add New") }} </a>
	</div>
			...
			<tbody>
				...
				<tr>
					...
					<td  data-th='{{ trans("messages.global.status") }}'>
						...
						<a href='{{URL::to('admin/photo-country-manager/view-photos/'.$result->country_id)}}' class="btn btn-info btn-small mt5">{{ trans("messages.global.view")}} </a>
