...
<div class="mws-panel grid_8">
	<div class="mws-panel-header" style="height: 46px;">
		<span> {{ trans("Add new Country Review") }} </span>
		<a href="{{URL::to('admin/photo-country-manager/list')}}" class="btn btn-success btn-small align">{{ trans("messages.system_management.back_to_cms") }} </a>
	</div>

	
	{{ Form::open(['role' => 'form','url' => 'admin/photo-country-manager/save','class' => 'mws-form' , 'enctype'=>"multipart/form-data"]) }}
