...
<div class="mws-panel grid_8">
	<div class="mws-panel-header" style="height: 46px;">
		<span> {{ trans("messages.system_management.add_new_faq") }} </span>
	...
	<div class="mws-panel-body no-padding tab-content">
			...
			<div id="{{ $i }}div" class="tab-pane {{ ($i ==  $language_code )?'active':'' }} ">
				<div class="mws-form-inline">
					<div class="mws-form-row ">
						...
						<div class="mws-form-item">
							{{ Form::textarea("data[$i]['question']",'', ['class' => 'small','id' => 'question_'.$i]) }}
							<div class="error-message help-inline">
					...
					<div class="mws-form-row ">
						...
						<div class="mws-form-item">
							{{ Form::textarea("data[$i]['answer']",'', ['class' => 'small','id' => 'answer_'.$i]) }}
		...
		<div class="mws-button-row">
			<div class="input" >
				...
				<a href="{{URL::to('admin/faqs-manager/add-faqs')}}" class="btn primary"><i class=\"icon-refresh\"></i> {{ trans('messages.system_management.reset') }}</a>
			</div>
		</div>
	</div>
	{{ Form::close() }} 
