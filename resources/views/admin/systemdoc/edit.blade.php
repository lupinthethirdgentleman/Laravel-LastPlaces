...
<div class="mws-panel grid_8">
	<div class="mws-panel-header" style="height: 46px;">
		<span> {{ trans("messages.system_management.edit_docs") }} </span>
		<a href="{{URL::to('admin/system-doc-manager')}}" class="btn btn-success btn-small align">{{ trans("messages.system_management.back") }} </a>
	</div>
	...
	<div class="mws-panel-body no-padding">
		<div class="mws-form-inline">
			...
			<div class="mws-form-row">
				{{  Form::label('title', trans("messages.system_management.system_document_label_upload_document") , ['class' => 'mws-form-label']) }}
				<div class="mws-form-item">
					{{ Form::text('title',$doc->title, ['class' => 'small']) }}
					<div class="error-message help-inline">
	...
	<div class="mws-panel-body no-padding tab-content"> 
		<div class="mws-button-row">
			<div class="input" >
				...
				<a href="{{URL::to('admin/system-doc-manager/edit-doc/'.$doc->id)}}" class="btn primary"><i class=\"icon-refresh\"></i> {{ trans('messages.system_management.reset') }}</a>
			</div>
		</div>
	</div>
	{{ Form::close() }} 
